...
<div class="container-fluid p-3 bg-light">
	...
	<div class="row">
		...
		<a href="checkOut.jsp"><i class="fa-solid fa-cart-plus fa-2x "></i></a>
			...
			<a href="logout" class="btn btn-primary btn text-white"><i class="fa-solid fa-right-to-bracket">
				</i>Logout
				</a>
		</div>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom">
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			...
			<li class="nav-item active"><a class="nav-link"
				href="allOldBook.jsp"><i class="fa-solid fa-book-open"></i>Old Book</a></li>
		</ul>
		<form class="form-inline my-2 my-lg-0">
			<a href="setting.jsp" class="btn btn-light my-2 my-sm-0 p-1" type="submit">
				<i class="fa-solid fa-gear"></i> Setting
			</a>
			<button class="btn btn-light my-2 my-sm-0 ml-1 p-1" type="submit">
				<i class="fa-solid fa-inbox"></i> Contact Us
			</button>
		</form>
	</div>
</nav>